...
namespace IHSDC.WebApp.Controllers
{
    ...
    public class Car_PC_Advance_ApplicationController : Controller
    {
        ...
        public ActionResult ChangeStatus(int? id)
        {
            ...
            CarPcModel car_PC_Advance_Application = con.carPcModel.Find(id);
        ...
        public ActionResult Search(int? id,string callaction)
        {
        ...
        public ActionResult Search1(int? id, string status)
        {
            switch (status)
            {
                case "mess1":
            ...
            "Amount,EMI,Previous_Loan_Is_Paid,Status,UpdatedBy,AadharNo,PANNo")] CarPcModel car_PC_Advance_Application,FormCollection collection)
        {
            if (ModelState.IsValid)
            {
                ...
                if (carPc==null)
                {
                    ...
                    con.SaveChanges();
                    int id = car_PC_Advance_Application.Application_Id;
                    ModelState.Clear();
